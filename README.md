...
Start a new GitHub Codespace whithin the GitHub repo
Install N8N
Create Virtual Environment
Activate Virtual Environment & Install LLM-Guard
...
Move into the Postgres Container and Create database and table
...
`\c airlinedb;`
    ...
    ```
Insert data into Postgres DB using Python script
Start N8N within your Virtual Environment